...
- Week 2~3：準備素材、完成Proposal
  - [x] 熟悉PTSD框架
  - [x] 研究遊戲、關卡邏輯
  - [x] 蒐集遊戲素材：**Sprite sheet**、**BGM**、**SFX**（音效）...等
  - [x] 完成專案 Proposal 撰寫
...
- Week 7：基本敵人系統
  - [x] 建立玩家與敵人的碰撞判定（踩踏敵人、玩家受傷）
  - [x] 開發敵人（栗寶寶 Goomba）的移動 AI
...
- Week 12：音效與音樂整合
  - [x] 匯入背景音樂（BGM）並設定循環播放
  - [x] 加入跳躍、吃金幣、踩死敵人等觸發音效
